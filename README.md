...
|-------|---------------|-----|
| Primary | `primary` | #4BBFD9 |
| Secondary | `secondary` | #3DDC97 |
| Background | `background` | #FAFAFA |
| Text (dark) | `text-primary` | #1F2D3D |
| CTA / Accent | `accent` | #FF6B6B |
| CTA Hover | `accent-hover` | #2BAF7D |
| Success | `success` | #D1F5E1 |
| Error | `error` | #FDE2E1 |
